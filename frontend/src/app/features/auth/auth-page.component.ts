...
export class AuthPageComponent {
  ...
  submit(): void {
    ...
    this.mode() === 'register' ? this.register() : this.login();
  }
  ...
  private register(): void {
    ...
    this.authService.register({
      ...
      error: (e) => this.errorMessage.set(e.error?.message ?? 'Could not register.'),
    });
  }
  ...
  private login(): void {
    ...
    this.authService.login({
      ...
      error: (e) => this.errorMessage.set(e.error?.message ?? 'Could not sign in.'),
    });
  }
}
